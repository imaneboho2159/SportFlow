...
<head>
    ...
    <title>SportConnect - Liste des Membres</title>
...
<div class="container">
    <div class="table-container">
        <h2 class="text-center text-light">Liste des Membres</h2>
        ...
        <div class="text-center mt-3">
            <a href="register.html" class="btn btn-success">Ajouter un membre</a>
        </div>
    </div>
</div>
</body>
