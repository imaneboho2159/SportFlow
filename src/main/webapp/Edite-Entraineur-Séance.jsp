...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <div class="navbar-nav ms-auto">
            <a class="nav-link animate__animated animate__fadeIn" href="trainer_dashboard.html">Retour</a>
...
<div class="container">
    <div class="form-container">
        <h2 class="text-center text-light">Modifier une Séance</h2>
        <form id="editSeanceForm">
            <div class="mb-3">
                <label for="membre" class="form-label">Membre</label>
                <input type="text" class="form-control" id="membre" value="Jean Dupont" readonly>
            </div>
            ...
            <div class="text-center">
                ...
                <a href="trainer_dashboard.html" class="btn btn-danger">Annuler</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    document.getElementById("heure").value = "10:00";
</script>
</body>
