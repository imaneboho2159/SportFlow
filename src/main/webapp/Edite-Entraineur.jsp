...
<head>
    ...
    <title>Modifier un Entraîneur - SportConnect</title>
...
<div class="container">
    ...
    <form action="entraineurs" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" value="Paul Martin" required>
        </div>

        <div class="mb-3">
            <label for="email" class="form-label text-light">Email</label>
            <input type="email" class="form-control" id="email" name="email" value="paul.martin@email.com" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="dob" name="dob" value="1985-07-10" required>
        </div>

        <div class="mb-3">
            <label for="specialty" class="form-label text-light">Spécialité</label>
        ...
        <div class="text-center">
            ...
            <a href="list_trainers.html" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
</div>
</body>
